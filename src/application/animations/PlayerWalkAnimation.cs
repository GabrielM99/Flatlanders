...
public class PlayerWalkAnimation : Animation<Player>
{
    ...
    public override void Bind(RuntimeAnimation runtimeAnimation, Player obj)
    {
        ...
        runtimeAnimation.BindProperty(LeftHandLocalRotation, (value) => obj.LeftHandSpriteRenderer.Entity.LocalRotation = value);

        runtimeAnimation.BindProperty(RightHandLocalPosition, (value) => obj.RightHandSpriteRenderer.Entity.LocalPosition = value);
        runtimeAnimation.BindProperty(RightHandLocalRotation, (value) => obj.RightHandSpriteRenderer.Entity.LocalRotation = value);
    }
}